...
public interface IBaseConsumer : ICoreConsumer
{
    ...
    /// <param name="typeInfo">Source-generated JSON metadata for the complete response type, including the paged wrapper for paged responses.</param>
    ...
    [Pure]
    ValueTask<OperationResult<TResponse>> Get<TResponse>(JsonTypeInfo<TResponse> typeInfo, string? id, string? overrideUri = null, bool allowAnonymous = false, CancellationToken cancellationToken = default);
    ...
    [Pure]
    ValueTask<OperationResult<TResponse>> Get<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    [Pure]
    ValueTask<OperationResult<PagedResult<TResponse>>> GetAll<TResponse>(JsonTypeInfo<PagedResult<TResponse>> typeInfo, RequestDataOptions? requestDataOptions = null, string? overrideUri = null,
    ...
    /// <returns>A task whose result is the requested operation Result.</returns>
    [Pure]
    ValueTask<OperationResult<PagedResult<TResponse>>> GetAll<TResponse>(JsonTypeInfo<PagedResult<TResponse>> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Create<TResponse>(JsonTypeInfo<TResponse> typeInfo, object request, string? overrideUri = null, bool allowAnonymous = false,
    ...
    ValueTask<OperationResult<TResponse>> Create<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    /// information.</returns>
    ValueTask<OperationResult<TResponse>> Post<TResponse>(JsonTypeInfo<TResponse> typeInfo, object request, string? overrideUri = null, bool allowAnonymous = false,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Post<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Update<TResponse>(JsonTypeInfo<TResponse> typeInfo, string? id, object request, string? overrideUri = null, bool allowAnonymous = false,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Update<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Put<TResponse>(JsonTypeInfo<TResponse> typeInfo, string? id, object request, string? overrideUri = null, bool allowAnonymous = false,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Put<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Delete<TResponse>(JsonTypeInfo<TResponse> typeInfo, string? id, string? overrideUri = null, bool allowAnonymous = false,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Delete<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestOptions requestOptions, CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Upload<TResponse>(JsonTypeInfo<TResponse> typeInfo, string? id, Stream stream, string fileName, string? overrideUri = null, bool allowAnonymous = false,
        CancellationToken cancellationToken = default);
    ...
    ValueTask<OperationResult<TResponse>> Upload<TResponse>(JsonTypeInfo<TResponse> typeInfo, RequestUploadOptions requestOptions, CancellationToken cancellationToken = default);
}
